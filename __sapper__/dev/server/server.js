	    ...
	    <div class="dropdown">
	        ...
	        <div class="dropdown-content" id="toggleDrop">
	            <ul>
	                ...
	                <li><a rel="prefetch"${(v => v == null ? "" : ` class="${escape(segment === "blog" ? "selected" : "")}"`)(segment === "blog" ? "selected" : "")} href="blog">blog</a></li>
	            </ul>
	        </div>
	    </div>
	</nav>`;
...
const css$2 = {
	code: "main.svelte-1izyinh{position:relative;max-width:56em;background-color:white;padding:2em;margin:0 auto;box-sizing:border-box}",
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport Nav from '../components/Nav.svelte';\\n\\n\\texport let segment;\\n</script>\\n\\n<style>\\n\\tmain {\\n\\t\\tposition: relative;\\n\\t\\tmax-width: 56em;\\n\\t\\tbackground-color: white;\\n\\t\\tpadding: 2em;\\n\\t\\tmargin: 0 auto;\\n        box-sizing: border-box;\\n    }\\n</style>\\n\\n<main>\\n    <h2>alan nguyen</h2>\\n    <Nav {segment}/>\\n\\t<slot></slot>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AAOC,IAAI,eAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,IAAI,CACf,gBAAgB,CAAE,KAAK,CACvB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,CACR,UAAU,CAAE,UAAU,AAC1B,CAAC\"}"
};
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main class="svelte-1izyinh">
	    <h2>alan nguyen</h2>
