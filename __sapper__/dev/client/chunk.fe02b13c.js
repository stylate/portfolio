...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			div.className = "clickGallery";
			add_location(div, file, 100, 4, 2010);
		},
...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 104, 12, 2203);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			img.src = img_src_value = getImage(ctx.data.id, ctx.idx);
			img.className = "svelte-1o8q0il";
			add_location(img, file, 102, 12, 2073);
			dispose = listen(img, "click", ctx.next);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p, file, 111, 8, 2349);
		},
