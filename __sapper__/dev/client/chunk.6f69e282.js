import { S as SvelteComponentDev, i as init, s as safe_not_equal, u as empty, h as insert, e as element, t as text, c as claim_element, b as children, d as claim_text, f as detach, g as add_location, j as append, q as set_data, C as destroy_each, a as space, n as noop, l as listen, r as run_all, D as set_style } from './chunk.347ae607.js';
...
function create_else_block(ctx) {
	...
	function select_block_type_1(ctx) {
		if (!ctx.isMobile && ctx.data.text) return create_if_block_2;
...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 104, 8, 2174);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			img = claim_element(nodes, "IMG", { alt: true, style: true, src: true, class: true }, false);
			var img_nodes = children(img);
		...
		h: function hydrate() {
			img.alt = "";
			set_style(img, "max-width", "40%");
			set_style(img, "max-height", "400px");
			img.src = img_src_value = getImage(ctx.data.id, ctx.idx);
			img.className = "svelte-1o8q0il";
			add_location(img, file, 102, 8, 2052);
			dispose = listen(img, "click", ctx.next);
		},
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p, file, 110, 8, 2305);
		},
